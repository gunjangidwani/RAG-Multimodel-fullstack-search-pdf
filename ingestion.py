...
if __name__ == "__main__":
    ...
    from chunking import (
        ...
        process_image_with_caption,
        process_table_with_description,
    )

    # Process a PDF document end-to-end
    pdf_file_path = "files/rag_paper.pdf"
    ...
    processed_images= process_image_with_caption(raw_chunks)

    # 3. Process tables with descriptions
    processed_tables = process_table_with_description(
        raw_chunks
    )
